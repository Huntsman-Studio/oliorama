		...
		if ( 'no' === $this->test_mode ) {
			...
			if ( 'Pending' === $res ) {
				...
				if ( current_user_can( 'manage_woocommerce' ) ) {
					...
					$error = __( 'Viva Wallet: Something went wrong! Please try again or come back later. If you are the admin of the website, please check Viva Wallet for WooCommerce plugin.', 'viva-wallet-for-woocommerce' );
					wc_add_notice( $error, 'error' );
				}
				return;
			}
